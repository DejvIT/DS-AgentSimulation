...
//meta! id="5"
public class Vaccination extends Agent
{
    ...
    public Vaccination(int id, Simulation mySim, Agent parent)
    {
    ...
    public void prepareReplication()
    {
        ...
        for (int i = 0; i < this.quantity; i++) {
            ...
            nurse.setSyringes(20);
            this.personal.add(nurse);
        }
    }
    ...
    public boolean isLunchTime() {
        return mySim().currentTime() >= 16200;
    }
    ...
    public String getStaffStatus() {
        ...
        for (int i = 0; i < this.personal.size(); i++) {
            ...
            status += (i+1) + ". Working: " + (this.personal.get(i).getIsBusy() ? "X" : "O") 
                    ...
                    + " | Syringes: " + this.personal.get(i).getSyringes()
	...
	private void init()
	{
		...
		new DoVaccination(Id.doVaccination, mySim(), this);
		addOwnMessage(Mc.refilled);
		addOwnMessage(Mc.lunchTime);
		addOwnMessage(Mc.vaccine);
