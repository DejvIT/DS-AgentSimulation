...
//meta! id="3"
public class Registration extends Agent
{
    ...
    public Registration(int id, Simulation mySim, Agent parent)
    {
    ...
    public boolean isLunchTime() {
        return mySim().currentTime() >= 10800;
    }
	...
	private void init()
	{
		...
		new DoRegistration(Id.doRegistration, mySim(), this);
		addOwnMessage(Mc.lunchTime);
		addOwnMessage(Mc.requestLunch);
		addOwnMessage(Mc.register);
	}
	//meta! tag="end"
}
